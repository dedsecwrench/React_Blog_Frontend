  ...
  return (
    <div>
      <div className='head-flex'>
        <div className='bollywood'>Hollywood<div className='line1'></div></div>
        ...
        <div className='TopPostBox'>
          {
            list.map((current, index) => {
              if (current.category === "Hollywood" && current.type === "topPost")
                return (
