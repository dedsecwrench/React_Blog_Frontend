  ...
  return (
    <div>
      <div className='head-flex'>
        <div className='bollywood'>Bollywood<div className='line1'></div></div>
        ...
        <div className='TopPostBox'>
          {
            list.map((current, index) => {
              if (current.category === "Bollywood" && current.type === "topPost")
                return (
